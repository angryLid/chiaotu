...
export const en: DeepString<typeof zhCN> = {
	...
	status: {
		...
		generate: {
			title: "Generate config from rules",
			rule: "Rules",
			selectAll: "Select all",
			matchCount: "{{nodeCount}} nodes will match the selected rules",
		...
		latest: {
			...
			empty: "Nothing generated yet. Pick rules and click “Generate & upload”.",
			name: "Name",
