 ...
 * - GET /generated/recent returns a page of generated results, newest first
 *   (10 per page) — returns an empty page when none yet;
...
/** A page of generated results (newest first). */
...
/**
 * Get one page of generated results, newest first (10 per page). Returns an
 * empty page when none yet.
 */
export function getRecentGenerated(page = 1): Promise<GeneratedPage> {
	return request<GeneratedPage>(`/generated/recent?page=${page}`);
}
